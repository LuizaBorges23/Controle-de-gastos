...
// import com.example.controle_de_gastos.adapter.TransactionAdapter; // (Não é mais usado aqui)
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupTransactionObservers(); // (Método helper modificado abaixo)
    ...
    // --- Método helper ---
    private void setupTransactionObservers() {
        // Observador para o Saldo Total (Mantido)
        transactionViewModel.getTotalBalance().observe(this, balance -> {
